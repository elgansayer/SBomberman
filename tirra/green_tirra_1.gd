...
func action(player):
	last_direction = rider.current_animation_direction
	.action(player)


func should_skid():
	return rider.pressed_direction == direction_table[rider.current_animation_direction]
...
func skid():
	...
	var animation = "skid_" + rider.current_animation_direction
...
func check_rider_stopped():
	...
	print(rider.pressed_direction, " ", direction_table[rider.current_animation_direction])
...
func reset_rider_speed():
	rider.extra_speed = 200


func hit_wall():
	.hit_wall()
	$AnimatedSprite.play("standing_" + rider.current_animation_direction)
...
# 		$AnimatedSprite.play("standing_" + rider.current_animation_direction)
# 	elif last_direction != rider.current_animation_direction:
# 		update_speed_anim()
