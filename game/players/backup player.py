...
func update_input():
	...
	if is_network_master():
		...
		# var bombing = false  #Input.is_action_pressed("set_bomb")
...
func dd_physics_process(_delta):
	...
	$Animator.update_animation(motion)
...
# 	var bomb_dict = bomb_position_table[facing_direction][frame]
...
# 	# facing_direction = animation_direction
...
# func award_tirra(tirra):
# 	var tirra_grid_position = tirra.grid_position

# 	var jump_gravity = 1000
# 	var custom_height = 1.15
# 	self.launch(tirra_grid_position, custom_height, jump_gravity)
...
func launch(grid_target, height_scale = 1.1, gravity_scale = GRAVITY_DEFAULT):
	...
	var animation = "flying_" + facing_direction
